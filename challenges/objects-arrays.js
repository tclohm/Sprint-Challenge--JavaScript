...
console.log(`${tyra.name} weighs ${tyra.weight}`);

// What was the diet of a velociraptor?
console.log(`${velo.name} diet is ${velo.diet}`);

// How long was a stegosaurus?
console.log(`${steg.name} is ${steg.length} tall`);

// What time period did tyrannosaurus live in?
console.log(`${tyra.name} lived in the ${tyra.period} period`);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(`${tyra.name} roars like ${tyra.roar()}`);
...
*/
const populationTotal = zooAnimals.reduce( (base, animal) => {
  return base += animal.population;
}, 0);
